...
const AddDoctor = () => {
    ...
    const { data: services, isLoading } = useQuery('services', () => fetch('https://shielded-beyond-83630.herokuapp.com/service').then(res => res.json()))
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://shielded-beyond-83630.herokuapp.com/doctor', {
                        method: 'POST',
                        headers: {
